...
The extension consists of a simple loader JS file that when included in the Simple Edit Layout (SEL) of a CT, it loads an additional JS and CSS file to enable Bootstrap 4 CSS & JS and Font Awesome 5 icons in both the Admin and Edit+ interface.
...
[`https://cdn.jsdelivr.net/gh/squizlabs/bootstrap-content-templates@latest/dist/bct-loader.js`](https://cdn.jsdelivr.net/gh/squizlabs/bootstrap-content-templates@latest/dist/bct-loader.js)
...
In order to use this extension on a Content Template, simply include the `bct-loader.js` file to the end of your Simple Edit Layout like this:
...
This will add a button next to the container that when clicked, will open a sidepanel from the right where everything inside the`<div class="bct-metadata">` will be visible.
